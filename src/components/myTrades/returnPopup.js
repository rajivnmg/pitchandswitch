              ...
              <Then>
                <div className="modal pitchSuccessful">
                  ...
                  <div className="header centerheading">
                    <span>Return Messages</span> Successfully saved.
                    <div className="cl" />
                  </div>
                  <p className="textSuccessful">
                    <span classNamne="gray">
                      Your feedback has been saved. Our team will contact you
                      soon.
                    </span>
                  </p>
                ...
                <div className="content">
                  <div className="return-request-form">
                    ...
                    <div className="form-row">
                      ...
                      <textarea
                        className="form-control textarea"
                        onChange={this.proposedSolution}
                        placeholder=""
                      />
                    </div>
                    <div className="form-row">

...
class DitchPopup extends Component {
  ...
  componentDidMount() {
    this.setState({
      offerTradeId: this.props.offerTrade ? this.props.offerTrade._id : ""
    });
  }
      ...
      >
        {close => (
          <div className="modal">
            ...
            <div className="header center-align marginTop">
              Are you sure you want to ditch?
              <div className="cl" />
            </div>
            <div className="content">
              <div className="return-request-form">
                <div className="form-row btn-row">
                  <button
                    className="ditch ditch"
                    onClick={() => this.ditchPitch(this.state.offerTrade)}
                  >
                    Ditch
                  </button>

...
class ShippingTypePopup extends Component {
  ...
  componentWillMount() {
    ...
    axios
      .get("trade/getShippingCost/" + this.tradeId + "/" + this.productID)
      .then(result => {
  ...
  componentDidMount() {
    axios
      .get("/user/viewUser/" + this.props.offerTrade.pitchUserId._id)
      .then(result => {
        if (result.data.code === 200) {
          this.setState({
            pitchUserDATA: result.data.result
          });
        }
      });
  }
                      ...
                      <TabPanel>
                        <div className="return-request-form">
                          <div className="brdr-box-div">
                            <p>
                              God of War 3 ~ Download Full Version PC
                              third-perso...
                            </p>
                          ...
                          <div className="form-row no-padding">
                            ...
                            <p className="secure-btm-text">
                              This payments use a secure 128-bit SSL encryption
                            </p>
                          </div>
                        </div>
                      </TabPanel>
                            ...
                            <div className="user_right">
                              ...
                              <p>
                                {this.state.pitchUserDATA.country
                                  ? this.state.pitchUserDATA.country.countryName
                                  : ""}
                              </p>
                              <p>

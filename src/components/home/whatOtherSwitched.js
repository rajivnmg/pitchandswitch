			...
			<div className="popularItems">
				...
				var productUrl = (localStorage.getItem('isLoggedIn') == 1 && localStorage.getItem('userId') == userIds)?'/my-trade-detail/'+proIDS:'/search-result/'+proIDS															
					return (					    					
						...
						<span className="catLink">{(switched.tradePitchProductId && switched.tradePitchProductId.productCategory)?switched.tradePitchProductId.productCategory.title:"NA"}</span>
						</div>

                ...
                <div className="popularItems">
                    ...
                    <Slider {...settings}>
                        {this.state.popularItems.map(function (item) {							
							...
							var userIds =(item._id && item._id.userId)?item._id.userId._id:'0'
							var productUrl = (localStorage.getItem('isLoggedIn') == 1 && localStorage.getItem('userId') == userIds)?'/my-trade-detail/'+((item._id)?item._id._id:0):'/search-result/'+((item._id)?item._id._id:0)					

...
class Register extends React.Component {
  ...
  componentDidMount() {
    if (this.props.match.params.id) {
      axios
        .get("/user/verifyUserEmail/" + this.props.match.params.id)
        .then(result => {
  ...
  _renderErrorMessage() {
    return (
      <div
        align="center"
        className={"alert alert-danger mt-4 inactiveUserError"}
        role="alert"
      >
        {this.state.message}
      </div>
          ...
          <div className="container">
            ...
            <div className="login">
              {this.state.showEmailVerification
                ? this._renderEmailVerificationSuccessMessage()
                : null}
                ...
                <Form submit={this.submit}>
                  <div>
                    {this.state.showFormError
                      ...
                      : null}
                    {this.state.showInactiveError
                      ? this._renderRespErrorMessage()
                      : null}

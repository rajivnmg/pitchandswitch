...
class Register extends React.Component {
  ...
  render() {
    return (
        ...
        <ul>
        <li><a href="/">Home</a></li><li><a href="#">My Treasure Chest</a></li><li>Edit Product</li>
        </ul>
        </div>
            ...
            <div className="form-row">
              ...
              <Form submit={this.submit}>
                ...
                <span className="astrik">*</span>
                  ...
                  <input id={"name"} className={"form-control textBox"} required={true} name={"name"} type={"name"} placeholder="Enter your name" defaultValue="SUPERGIRL Cw TV Series Custom Comic Book Superhero Minifigure" />
                </div>
                        <div className="form-row">
                        <div className="invalid-feedback validation"> </div>
                <span className="astrik">*</span>
                  ...
                  <textarea
                    ...
                    name={"description"}
                    type={"description"}
                    placeholder="" defaultValue="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. "
                    ></textarea>
                ...
                <div className="form-row">
                  ...
                  <select required={true} name={"category"} defaultValue="Red">
                  <option >Red</option>
                  <option >Green</option>
                  </select>
                  </div>
                ...
                <span className="astrik">*</span>
                  ...
                  <div className="select-box">
                  <select required={true} name={"category"} defaultValue="Toy">
        ...
        <span className="astrik">*</span>
                  ...
                  <input id={"size"} className={"form-control textBox"} required={true} name={"size"} type={"text"} placeholder="" defaultValue="Medium" /></div>
        ...
        <span className="astrik">*</span>
                  <label className="label" htmlFor={"status"}>Status</label>
                   <div className="select-box">
                   <select required={true} name={"status"} defaultValue="Active">
                  <option>Select</option>
